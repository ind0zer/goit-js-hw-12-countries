...
})({"5SWuX":[function(require,module,exports,__globalThis) {
...
refs.input.addEventListener('input', (0, _lodashDebounceDefault.default)(onInput, DEBOUNCE_DELAY));
function onInput(event) {
    ...
    (0, _fetchCountriesDefault.default)(query).then((data)=>renderMarkup(data)).catch(()=>{
        clearMarkup();
        (0, _core.error)({
...
function renderMarkup(countries) {
    ...
    if (countries.length > 1 && countries.length <= 10) {
        const listMarkup = countries.map(({ name })=>`<li>${name}</li>`).join('');
...
},{"lodash.debounce":"3JP5n","@pnotify/core":"9RSjy","@pnotify/core/dist/PNotify.css":"c4y47","@pnotify/core/dist/BrightTheme.css":"grIyt","@parcel/transformer-js/src/esmodule-helpers.js":"8XEDl","./fetchCountries":"fTQqv"}],"3JP5n":[function(require,module,exports,__globalThis) {
/**
...
},{}],"9RSjy":[function(require,module,exports,__globalThis) {
var global = arguments[3];
!function(t, e) {
    e(exports);
}(this, function(t) {
...
},{}],"c4y47":[function() {},{}],"grIyt":[function() {},{}],"8XEDl":[function(require,module,exports,__globalThis) {
...
},{}],"fTQqv":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"8XEDl"}]},["5SWuX","8lqZg"], "8lqZg", "parcelRequire94c2")
